# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 22:36:23 2021
...
def f_plotting(height_map, max_index):
...
ds_steps = 11  # Number of levels. Grid points = ((ds_steps^2)+1)^2.
...
f_plotting(Final_height_map, max_index)  # Plotting.